...
<body>
    ...
    <div class="news-hero">
        <div class="container text-center position-relative">
            <h1 class="fw-bold display-5 mb-3">ENT PENS News Portal</h1>
            <p class="lead mb-0">Informasi terkini dan terpercaya dari EET and Network Team</p>
        </div>
    </div>
    ...
    <div class="container mb-5">
        <div class="news-content animate-fadein">
            ...
            <div class="tag-cloud">
                ...
                <span class="tag">#Jaringan</span>
                <span class="tag">#EET</span>
